...
public class JMatLink { //implements ImageObserver  { 
    ...
    ***************************************************************************/
    public long engOpenSingleUse()
    {
        ...
        return engOpenSingleUse("matlab -nojvm -nosplash");
    }
    ...
    */
    ...
    public boolean engIsRunning()
    {
        return coreJMatLink.getThreadStatus()==CoreJMatLink.THREAD_RUNNING;
    }
