...
class ArrayObject extends jacl.tcl.lang.ReflectObject
{
 ...
 */
            ...
            TclException        // May encounter bad index.
    {
        ...
        */
        ...
        {
            return newInstance(interp, arrayClass, obj);
        }
 ...
 */
    ...
    // or wrong type in tclValueListObj.
    {
        ...
        */
        ...
        Object javaValue = JavaInvoke.convertTclObject(interp, arrayClass,
                value);
