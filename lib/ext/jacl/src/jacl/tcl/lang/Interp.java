 ...
 */
    ...
    public Interp()
    {
        ...
        */
            ...
            setVar("tcl_library", "resource:/jacl/tcl/lang/library",
                    TCL.GLOBAL_ONLY);
            if (Util.isWindows())
            {
        ...
        */
            ...
            evalResource("/jacl/tcl/lang/library/init.tcl");
 ...
 */
    ...
    protected void
            createCommands()
    {
        Extension.loadOnDemand(this, "after", "jacl.tcl.lang.AfterCmd");
        Extension.loadOnDemand(this, "append", "jacl.tcl.lang.AppendCmd");
        Extension.loadOnDemand(this, "array", "jacl.tcl.lang.ArrayCmd");
        Extension.loadOnDemand(this, "break", "jacl.tcl.lang.BreakCmd");
        Extension.loadOnDemand(this, "case", "jacl.tcl.lang.CaseCmd");
        Extension.loadOnDemand(this, "catch", "jacl.tcl.lang.CatchCmd");
        Extension.loadOnDemand(this, "cd", "jacl.tcl.lang.CdCmd");
        Extension.loadOnDemand(this, "close", "jacl.tcl.lang.CloseCmd");
        Extension.loadOnDemand(this, "continue", "jacl.tcl.lang.ContinueCmd");
        Extension.loadOnDemand(this, "concat", "jacl.tcl.lang.ConcatCmd");
        Extension.loadOnDemand(this, "eof", "jacl.tcl.lang.EofCmd");
        Extension.loadOnDemand(this, "eval", "jacl.tcl.lang.EvalCmd");
        Extension.loadOnDemand(this, "error", "jacl.tcl.lang.ErrorCmd");
        if (! Util.isMac())
        {
            Extension.loadOnDemand(this, "exec", "jacl.tcl.lang.ExecCmd");
        }
        Extension.loadOnDemand(this, "exit", "jacl.tcl.lang.ExitCmd");
        Extension.loadOnDemand(this, "expr", "jacl.tcl.lang.ExprCmd");
        Extension.loadOnDemand(this, "fblocked", "jacl.tcl.lang.FblockedCmd");
        Extension.loadOnDemand(this, "fconfigure", "jacl.tcl.lang.FconfigureCmd");
        Extension.loadOnDemand(this, "file", "jacl.tcl.lang.FileCmd");
        Extension.loadOnDemand(this, "flush", "jacl.tcl.lang.FlushCmd");
        Extension.loadOnDemand(this, "for", "jacl.tcl.lang.ForCmd");
        Extension.loadOnDemand(this, "foreach", "jacl.tcl.lang.ForeachCmd");
        Extension.loadOnDemand(this, "format", "jacl.tcl.lang.FormatCmd");
        Extension.loadOnDemand(this, "gets", "jacl.tcl.lang.GetsCmd");
        Extension.loadOnDemand(this, "global", "jacl.tcl.lang.GlobalCmd");
        Extension.loadOnDemand(this, "glob", "jacl.tcl.lang.GlobCmd");
        Extension.loadOnDemand(this, "if", "jacl.tcl.lang.IfCmd");
        Extension.loadOnDemand(this, "incr", "jacl.tcl.lang.IncrCmd");
        Extension.loadOnDemand(this, "info", "jacl.tcl.lang.InfoCmd");
        Extension.loadOnDemand(this, "list", "jacl.tcl.lang.ListCmd");
        Extension.loadOnDemand(this, "join", "jacl.tcl.lang.JoinCmd");
        Extension.loadOnDemand(this, "lappend", "jacl.tcl.lang.LappendCmd");
        Extension.loadOnDemand(this, "lindex", "jacl.tcl.lang.LindexCmd");
        Extension.loadOnDemand(this, "linsert", "jacl.tcl.lang.LinsertCmd");
        Extension.loadOnDemand(this, "llength", "jacl.tcl.lang.LlengthCmd");
        Extension.loadOnDemand(this, "lrange", "jacl.tcl.lang.LrangeCmd");
        Extension.loadOnDemand(this, "lreplace", "jacl.tcl.lang.LreplaceCmd");
        Extension.loadOnDemand(this, "lsearch", "jacl.tcl.lang.LsearchCmd");
        Extension.loadOnDemand(this, "lsort", "jacl.tcl.lang.LsortCmd");
        Extension.loadOnDemand(this, "namespace", "jacl.tcl.lang.NamespaceCmd");
        Extension.loadOnDemand(this, "open", "jacl.tcl.lang.OpenCmd");
        Extension.loadOnDemand(this, "package", "jacl.tcl.lang.PackageCmd");
        Extension.loadOnDemand(this, "proc", "jacl.tcl.lang.ProcCmd");
        Extension.loadOnDemand(this, "puts", "jacl.tcl.lang.PutsCmd");
        Extension.loadOnDemand(this, "pwd", "jacl.tcl.lang.PwdCmd");
        Extension.loadOnDemand(this, "read", "jacl.tcl.lang.ReadCmd");
        Extension.loadOnDemand(this, "regsub", "jacl.tcl.lang.RegsubCmd");
        Extension.loadOnDemand(this, "rename", "jacl.tcl.lang.RenameCmd");
        Extension.loadOnDemand(this, "return", "jacl.tcl.lang.ReturnCmd");
        Extension.loadOnDemand(this, "scan", "jacl.tcl.lang.ScanCmd");
        Extension.loadOnDemand(this, "seek", "jacl.tcl.lang.SeekCmd");
        Extension.loadOnDemand(this, "set", "jacl.tcl.lang.SetCmd");
        Extension.loadOnDemand(this, "socket", "jacl.tcl.lang.SocketCmd");
        Extension.loadOnDemand(this, "source", "jacl.tcl.lang.SourceCmd");
        Extension.loadOnDemand(this, "split", "jacl.tcl.lang.SplitCmd");
        Extension.loadOnDemand(this, "string", "jacl.tcl.lang.StringCmd");
        Extension.loadOnDemand(this, "subst", "jacl.tcl.lang.SubstCmd");
        Extension.loadOnDemand(this, "switch", "jacl.tcl.lang.SwitchCmd");
        Extension.loadOnDemand(this, "tell", "jacl.tcl.lang.TellCmd");

        /*
        //Mo: moved loading of test commands into JavaTestExtension.java
        Extension.loadOnDemand(this, "testcmdinfo",
            "jacl.tcl.lang.TestcmdinfoCmd");
        Extension.loadOnDemand(this, "testdcall",
            "jacl.tcl.lang.TestdcallCmd");
        Extension.loadOnDemand(this, "testfhandle",
            "jacl.tcl.lang.TestfhandleCmd");
        Extension.loadOnDemand(this, "testgetplatform",
            "jacl.tcl.lang.TestgetplatformCmd");
        Extension.loadOnDemand(this, "testsetplatform",
            "jacl.tcl.lang.TestsetplatformCmd");
        Extension.loadOnDemand(this, "testtranslatefilename",
            "jacl.tcl.lang.TesttranslatefilenameCmd");
        */

        Extension.loadOnDemand(this, "time", "jacl.tcl.lang.TimeCmd");
        Extension.loadOnDemand(this, "trace", "jacl.tcl.lang.TraceCmd");
        Extension.loadOnDemand(this, "unset", "jacl.tcl.lang.UnsetCmd");
        Extension.loadOnDemand(this, "update", "jacl.tcl.lang.UpdateCmd");
        Extension.loadOnDemand(this, "uplevel", "jacl.tcl.lang.UplevelCmd");
        Extension.loadOnDemand(this, "upvar", "jacl.tcl.lang.UpvarCmd");
        Extension.loadOnDemand(this, "vwait", "jacl.tcl.lang.VwaitCmd");
        Extension.loadOnDemand(this, "while", "jacl.tcl.lang.WhileCmd");
