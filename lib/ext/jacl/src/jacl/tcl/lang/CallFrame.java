...
class CallFrame
{
     ...
     * @throws TclException if error occurs in parameter bindings.
     */
     ...
     * @throws TclException if wrong number of arguments.
     */
     ...
     * @throws TclException if the variable cannot be found and
     ...
     * @throws TclException if the upvar cannot be created.
     */
     ...
     * @throws TclException if s is a valid level specifier but
