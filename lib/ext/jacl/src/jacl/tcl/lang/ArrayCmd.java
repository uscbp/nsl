...
class ArrayCmd implements Command
{
     ...
     * @param var is the string representation of the
     *               variable that was passed in.
     * @throws TclException - not array
     */
     ...
     * @param sid is the string represenation of the
     *               SearchId that was passed in.
     * @throws TclException - bad search Id
     */
     ...
     *
     * @param pattern  is the string use dto identify the SearchId
