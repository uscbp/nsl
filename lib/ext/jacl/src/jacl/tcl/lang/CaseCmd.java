 ...
 * WARRANTIES.
 * 
 * RCS: @(#) $Id: CaseCmd.java,v 1.1.1.1 1998/10/14 21:09:18 cvsadmin Exp $
 *
 */
...
{
    /**
     * Executes a "case" statement. See Tcl user
     * documentation for details.
     *
     * @param interp the current interpreter.
     * @param argv   command arguments.
     * @throws TclException If incorrect number of arguments.
     */
