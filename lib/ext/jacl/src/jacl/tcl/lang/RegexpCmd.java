 ...
 * WARRANTIES.
 * 
 * RCS: @(#) $Id: RegexpCmd.java,v 1.1.1.1 1998/10/14 21:09:18 cvsadmin Exp $
 */
 ...
 */
    ...
    {
        interp.createCommand("regexp", new jacl.tcl.lang.RegexpCmd());
        interp.createCommand("regsub", new jacl.tcl.lang.RegsubCmd());
    }
 ...
 */
    ...
    private static void
            ...
            throws TclException
    {
        int currentObjIndex, stringObjIndex;
