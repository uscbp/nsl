...
public class NslArcTan2
{
    // 0d native ints

    public static int eval(int a, int b)
    {
        return (int)Math.atan2(a, b);
    }
...
// 2d native ints
    ...
    public static int[][] eval(int[][] dest, int[][] a, int b)
    {
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                dest[i1][i2] = (int)Math.atan2(a[i1][i2], b);
            }
        }
        return dest;
    }
    ...
    public static int[][] eval(int[][] dest, int[][] a, int[][] b)
    {
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                dest[i1][i2] = (int)Math.atan2(a[i1][i2], b[i1][i2]);
            }
        }
        return dest;
    }
    ...
    public static int[][][] eval(int[][][] dest, int[][][] a, int b)
    {
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                for (i3 = 0; i3 < len3; i3++)
                {
                    dest[i1][i2][i3] = (int)Math.atan2(a[i1][i2][i3], b);
                }
            }
        }
        return dest;
    ...
    public static int[][][] eval(int[][][] dest, int[][][] a, int[][][] b)
    {
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                for (i3 = 0; i3 < len3; i3++)
                {
                    dest[i1][i2][i3] = (int)Math.atan2(a[i1][i2][i3], b[i1][i2][i3]);
                }
            }
        }
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                for (i3 = 0; i3 < len3; i3++)
                {
                    for (i4 = 0; i4 < len4; i4++)
                    {
                        dest[i1][i2][i3][i4] = (int)Math.atan2(a[i1][i2][i3][i4], b);
                    }
                }
            }
        }
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                for (i3 = 0; i3 < len3; i3++)
                {
                    for (i4 = 0; i4 < len4; i4++)
                    {
                        dest[i1][i2][i3][i4] = (int)Math.atan2(a[i1][i2][i3][i4], b[i1][i2][i3][i4]);
                    }
                }
            }
        }
...
//0d nsl int by Weifang
    ...
    {
        return (int)Math.atan2(a.getint(), b);
    }

    public static int eval(int a, NslInt0 b)
    {
        return (int)Math.atan2(a, b.getint());
    }

    public static int eval(NslInt0 a, NslInt0 b)
    {
        return (int)Math.atan2(a.getint(), b.getint());
    }
    ...
    public static int eval(NslDinInt0 a, NslInt0 b)
    {
        return (int)Math.atan2(a.getint(), b.getint());
    }

    public static int eval(NslInt0 a, NslDinInt0 b)
    {
        return (int)Math.atan2(a.getint(), b.getint());
    }
...
// 1d native floats
    ...
    public static float[] eval(float[] dest, float[] a, float[] b)
    {
        ...
        for (i = 0; i < len; i++)
        {
            dest[i] = (float)Math.atan2(a[i], b[i]);
        }
        return dest;
    }
...
// 2d native floats
    ...
    public static float[][] eval(float[][] dest, float[][] a, float b)
    {
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                dest[i1][i2] = (float)Math.atan2(a[i1][i2], b);
            }
        }
        return dest;
    }
    ...
    public static float[][] eval(float[][] dest, float[][] a, float[][] b)
    {
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                dest[i1][i2] = (float)Math.atan2(a[i1][i2], b[i1][i2]);
            }
        }
        return dest;
    }
    ...
    public static float[][][] eval(float[][][] dest, float[][][] a, float b)
    {
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                for (i3 = 0; i3 < len3; i3++)
                {
                    dest[i1][i2][i3] = (float)Math.atan2(a[i1][i2][i3], b);
                }
            }
        }
        return dest;
    ...
    public static float[][][] eval(float[][][] dest, float[][][] a, float[][][] b)
    {
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                for (i3 = 0; i3 < len3; i3++)
                {
                    dest[i1][i2][i3] = (float)Math.atan2(a[i1][i2][i3], b[i1][i2][i3]);
                }
            }
        }
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                for (i3 = 0; i3 < len3; i3++)
                {
                    for (i4 = 0; i4 < len4; i4++)
                    {
                        dest[i1][i2][i3][i4] = (float)Math.atan2(a[i1][i2][i3][i4], b);
                    }
                }
            }
        }
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                for (i3 = 0; i3 < len3; i3++)
                {
                    for (i4 = 0; i4 < len4; i4++)
                    {
                        dest[i1][i2][i3][i4] = (float)Math.atan2(a[i1][i2][i3][i4], b[i1][i2][i3][i4]);
                    }
                }
            }
        }
...
//0d nsl float by Weifang
    ...
    {
        return (float)Math.atan2(a.getfloat(), b);
    }

    public static float eval(float a, NslFloat0 b)
    {
        return (float)Math.atan2(a, b.getfloat());
    }

    public static float eval(NslFloat0 a, NslFloat0 b)
    {
        return (float)Math.atan2(a.getfloat(), b.getfloat());
    }
...
// 2d native doubles
    ...
    public static double[][] eval(double[][] dest, double[][] a, double b)
    {
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                dest[i1][i2] = Math.atan2(a[i1][i2], b);
            }
        }
        return dest;
    }
    ...
    public static double[][] eval(double[][] dest, double[][] a, double[][] b)
    {
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                dest[i1][i2] = Math.atan2(a[i1][i2], b[i1][i2]);
            }
        }
        return dest;
    }
    ...
    public static double[][][] eval(double[][][] dest, double[][][] a, double b)
    {
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                for (i3 = 0; i3 < len3; i3++)
                {
                    dest[i1][i2][i3] = Math.atan2(a[i1][i2][i3], b);
                }
            }
        }
        return dest;
    ...
    public static double[][][] eval(double[][][] dest, double[][][] a, double[][][] b)
    {
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                for (i3 = 0; i3 < len3; i3++)
                {
                    dest[i1][i2][i3] = Math.atan2(a[i1][i2][i3], b[i1][i2][i3]);
                }
            }
        }
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                for (i3 = 0; i3 < len3; i3++)
                {
                    for (i4 = 0; i4 < len4; i4++)
                    {
                        dest[i1][i2][i3][i4] = Math.atan2(a[i1][i2][i3][i4], b);
                    }
                }
            }
        }
        ...
        for (i1 = 0; i1 < len1; i1++)
        {
            for (i2 = 0; i2 < len2; i2++)
            {
                for (i3 = 0; i3 < len3; i3++)
                {
                    for (i4 = 0; i4 < len4; i4++)
                    {
                        dest[i1][i2][i3][i4] = Math.atan2(a[i1][i2][i3][i4], b[i1][i2][i3][i4]);
                    }
                }
            }
        }
...
//0d nsl double by Weifang
    ...
    {
        return Math.atan2(a.getdouble(), b);
    }

    public static double eval(double a, NslDouble0 b)
    {
        return Math.atan2(a, b.getdouble());
    }

    public static double eval(NslDouble0 a, NslDouble0 b)
    {
        return Math.atan2(a.getdouble(), b.getdouble());
    }
