...
///------------3-----------------------------------------------
     ...
     * @return the value of the element in <tt>pos1</tt> in java numerical type <tt>float</tt>.
     */
...
//----------------------------------------------------------
    ...
    */
    ...
    public NslData duplicateThis()
    {
        if (isDataSet())
        {
            return new NslDouble4(this._data);
        }
        else
        {
            return new NslDouble4();
        }
    }
