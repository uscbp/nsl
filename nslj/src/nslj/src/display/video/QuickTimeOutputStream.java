 ...
 */
package nslj.src.display.video;

import nslj.src.display.video.AtomDataOutputStream;
import nslj.src.display.video.FilterImageOutputStream;
...
public class QuickTimeOutputStream
{
    ...
    private class LeafAtom extends Atom
    {
         ...
         * ImageOutputStream.
         *
         * @param name The type of the atom.
         */
     ...
     * @param format the video videoFormat "JPG" or "PNG".
     * @throws IllegalArgumentException if videoFormat is null or if
     *                                  framerate is <= 0
     */
     ...
     *
     * @throws IllegalStateException if the dimension of the video track
